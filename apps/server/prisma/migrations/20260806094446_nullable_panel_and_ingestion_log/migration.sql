...
-- Pricing (Panel.b2bPriceGBP, Marker.addOnPriceGBP) is dropped by
-- 20260805150000_optional_panel_and_no_pricing, which runs earlier in this
-- chain and owns that change outright. Dropping it a second time here would
-- fail against an empty database — the column no longer exists by the time
-- this migration runs.
