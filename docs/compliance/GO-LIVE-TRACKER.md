...
11. Railway region: CONFIRMED Amsterdam (EU West) for both app and Postgres, migrated 2026-08. Owner: Eng. Status: DONE.
12. Cloudflare R2 backup bucket: CONFIRMED Western Europe jurisdiction, migrated 2026-08. Owner: Eng. Status: DONE.
13. Resend sending region noted in ROPA. Owner: Eng. Recommended. Status: NOT STARTED (still to confirm).
